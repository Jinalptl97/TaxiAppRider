...
public class ResetPasswordOTPscreen extends AppCompatActivity {
        ...
        otpsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editextotp.getText().toString().equals(id) || editextotp.getText().toString().equals(otp)) {
                    ...
                    input_layout_otp.setError("Please Check OTP");
                }
            }
        });
        MyApplication.getInstance().trackScreenView("ResetPasswordOTPscreen");
