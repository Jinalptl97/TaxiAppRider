...
public class ShortByETA extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fregment_short_by_eta, container, false);

        context = getActivity();

        list3=(RecyclerView)view.findViewById(R.id.list3);
        ...
        list3.setLayoutManager(layoutManager);
