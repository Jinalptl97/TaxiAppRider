...
public class ShortByPrice extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
   ...
   /* public static ShortByPrice newInstance(Bundle bundle, String title) {
        ShortByPrice fragmentFirst = new ShortByPrice();
        rej=bundle.getString("rej","1");
        cartype=bundle.getString("cartype","");
        canceldriver=bundle.getString("cancledrive","");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fregment_short_by_price, container, false);
        ...
        Log.e("driver size",":::"+driverInfolist.size());
