...
public class DriverInfoAdapter3 extends RecyclerView.Adapter<DriverInfoAdapter3.MyView> {
    Context context;
    ArrayList<DriverInfo> driverinfo_list = new ArrayList<>();
    Pref_Master pref_master;


    public DriverInfoAdapter3(Context context, ArrayList<DriverInfo> driverinfo_list) {
    ...
    @Override
    public DriverInfoAdapter3.MyView onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final DriverInfoAdapter3.MyView holder, final int position) {
        ...
        Log.e("distanceeee", "" + driverinfo_list.get(position).getDistance());
